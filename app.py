...
config_str = st.secrets["auth"]["config"]
config = yaml.load(config_str, Loader=SafeLoader)
# Pre-hashing all plain text passwords once
creds = stauth.Hasher.hash_passwords(config['credentials'])
...
if st.session_state.get('authentication_status'):
    ...
    if st.session_state['username'] == 'khuong':
